...
const OnlyFor = ({ lang, onButtonClick }: any) => {
  return (
        ...
        <div className="lg:w-[40%]">
          ...
          <div className="flex items-center justify-between">
            <div
              ...
              className="block w-max rounded-[8px] text-sm lg:text-base bg-contact text-white py-2 px-3 lg:px-3 hover:bg-[#A30505] cursor-pointer"
            >
              {lang?.textBtn}
              <FontAwesomeIcon
                icon={faArrowRight}
