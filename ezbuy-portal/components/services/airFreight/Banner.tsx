...
const Banner = ({ lang, locale }: any) => {
  ...
  return (
    <section className={clsx("pt-16 lg:pt-24", "container px-4")}>
      <div className="uppercase font-black text-2xl lg:text-4xl text-brand-primary text-center mb-4">
        {lang?.services?.airFreight?.efficient}
      </div>
      <div
        className={clsx(
      ...
      >
        <p className="text-sm lg:text-base lg:w-[50%] text-center">
          {lang?.services?.airFreight?.elevate}
        </p>
      </div>
