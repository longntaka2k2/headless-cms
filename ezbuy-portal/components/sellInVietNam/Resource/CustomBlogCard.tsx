    ...
    <article className={className}>
      ...
      >
        ...
        >
          <div>
            <Image
              ...
              className={clsx(
                "cursor-pointer lg:max-w-[328px] max-w-[308px]  w-full h-[200px] object-cover object-center mx-auto rounded-2xl mb-6",
        ...
        <div className="flex justify-end text-sm font-medium">
          <Link
            href={url}
            className="text-brand-secondary group hover:underline"
          >
            {cta ?? "Read more"}{" "}
            <FontAwesomeIcon
              icon={faArrowRight}
