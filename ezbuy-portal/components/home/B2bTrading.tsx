...
const B2bTrading = ({ lang }: { lang: any }) => {
  const { b2bTrading } = lang.home;
  const contents = [
    {
      ...
      <div className=" container mx-auto">
        <div className="">
          <div className="relative top-10 z-10">
            <div className="flex flex-col-reverse py-12 pr-6 pl-0 z-10 items-end">
              <div className="md:w-[576px] flex flex-col gap-6 px-4">
                <div className="flex flex-col items-start justify-start gap-[8px]">
                  ...
                  <div className="self-stretch relative text-base leading-[150%]">
                    {b2bTrading.subHeading}
                  </div>
                </div>
                <Link
                  href={"/services/b2b-trading-ecommerce"}
        ...
        <div
          className={clsx(
            "md:absolute top-0 md:left-[0] md:w-[65%] h-[480px]",
            "bg-[url('https://strapi-ezbuy.ichiba.net/uploads/Warehouse_Fulfillment_87f941d13a.png')]",
            "bg-cover bg-center"
          )}
        >
          <div
            className={clsx(
              "absolute lg:hidden bottom-[-100px] md:left-[372px] lg:gap-4 text-center text-base",
          ...
          >
            <div className="hidden lg:flex flex-row items-start justify-start gap-2 text-white">
              <div className="bg-gray-1 flex flex-col p-2 items-center justify-center">
                <div className="relative leading-[150%] inline-block w-6 h-6 shrink-0">
