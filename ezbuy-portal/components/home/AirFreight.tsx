...
const AirFreight = ({ lang }: { lang: any }) => {
  const { airFreight } = lang.home;
  const contents = [
    {
    ...
    <section className="relative md:h-[700px] mb-16">
      <div className=" container mx-auto">
        ...
        >
          <div
            className={clsx(
              "absolute lg:hidden bottom-[-90px] text-center text-base overflow-hidden gap-4",
          ...
          >
            <div className="hidden lg:flex flex-row items-start justify-start gap-2 text-white">
              <div
                className="bg-gray-1 flex flex-col p-2 items-center justify-center"
