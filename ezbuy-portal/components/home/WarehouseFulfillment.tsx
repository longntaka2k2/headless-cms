...
const WarehouseFulfillment = ({ lang }: { lang: any }) => {
  const { warehouseFulfillment } = lang.home;
  const contents = [
    {
    ...
    <section className="relative md:h-[700px] mb-16">
      <div className=" container mx-auto">
              ...
              <div className="md:w-[576px] flex flex-col gap-6 px-4">
                <div className="flex flex-col items-start justify-start gap-[8px]">
                  <p className="relative text-2xl font-bold">
                    {warehouseFulfillment.heading}
                  </p>
                  <div className="self-stretch relative text-base leading-[150%]">
                    {warehouseFulfillment.subHeading}
                  </div>
                </div>
                <Link
        ...
        >
          <div
            className={clsx(
              "absolute lg:hidden bottom-[-100px] md:left-[372px] gap-4 text-center text-base overflow-hidden",
