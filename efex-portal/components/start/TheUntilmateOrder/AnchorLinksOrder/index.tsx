...
const AnchorLinks = (props: Props) => {
  ...
  return (
    <div className="px-1 py-4 sticky top-[72px] z-[49] bg-white">
      <div className="container relative">
        <div
          className={clsx(
            "!w-full  mx-auto relative z-[1] no-scrollbar",
            classes.scroll,
            classes.maxScroll
          )}
          ref={containerRef}
        >
          <div className=" gap-4 items-center no-scrollbar">
            {props?.items?.map((item, index) => {
              ...
              return (
                <div
                  ...
                  role="button"
                  className={clsx(
                    "px-4 py-2 no-underline w-full ",
                    "border-l border-[#6666663a] ",
                    isActive && " text-brand-primary border-brand-primary border-l-[3px] relative right-[1px]",
                      isActive
                      ? classes.active
                      : " "
                  )}
