...
const FooterEFFEXFulfillment = ({ lang }: any) => {
  return (
    <>
      <div className="pt-6 pb-10 lg:pt-15 lg:pb-6 overflow-hidden bg-[url('https://strapi-efex.ichiba.net/uploads/Footer_54b32c6078.svg')]">
            ...
            <div>
              ...
              <div className="flex gap-2 items-center">
                <Image
                  ...
                  alt="EFEX"
                />
                <p className="text-sm">{lang.address}</p>
              </div>
            </div>
