    ...
    <>
      <div className="py-6 lg:py-[54px]">
        <div className="container px-4 lg:px-0">
          ...
          <div className="bg-primary-1 rounded-xl flex flex-col lg:flex-row items-center gap-6 lg:gap-20 px-4 lg:px-10 py-6 lg:py-0 lg:mb-16">
          ...
          <div className="hidden lg:flex justify-center mt-10">
            <Link
              href={"#"}
              className="py-2 px-3 lg:py-3 lg:px-5 text-sm rounded-lg bg-brand-primary text-white"
            >
              {lang.textBtn}
            </Link>
          </div>
