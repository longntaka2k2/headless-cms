...
const WeAre = ({ lang }: { lang: any }) => {
  const location = [
    {
      stt: 0,
      title: lang.homePage.vietNam,
      number: "2",
      map: mapvi,
      class: "top-[255px] right-[63px]",
      addres: [
        {
          title: lang.homePage.hn.title,
          content: [lang.homePage.hn.content[0]],
          img: hanoi,
        },
        {
          title: lang.homePage.hcm.title,
          content: [lang.homePage.hcm.content[0]],
          img: hcm,
        },
      ],
    },
    {
      ...
      addres: [
        {
          title: "TEXAS",
          content: ["11462 Pagemill Rd, Dallas, TX 75243, United States"],
          img: manches,
        },
        {
          title: "California",
          content: [
            "10832 Capital Ave Unit 5A, Garden Grove, CA 92843, United States",
            "1316 John Reed Ct, City Of Industry, CA 91745, United States",
            "147 Precita Ave, San Francisco, California, 94110, United States",
          ],
          img: manches,
        },
        {
          title: "Chicago",
          content: [
            "5839 W Montrose Ave, Chicago, IL, 60634 ILLINOIS, United States",
          ],
          img: manches,
        },
      ],
  ...
  return (
    <div className="mt-10 text-[#333] px-4 lg:relative z-[1]">
      <div className="lg:relative z-[1] lg:container lg:pt-[120px] lg:mt-[70px]">
        ...
        <EzImage
          src={"/uploads/Frame_427318518_565108ef80.svg"}
          unoptimized
          quality={100}
          width={500}
          height={300}
        ...
        <div className="flex justify-between items-center lg:hidden">
          ...
          <div className="flex gap-4">
            <EzImage
              ...
              height={36}
              className={clsx(
                item.stt === 0 ? "pointer-events-none opacity-50" : ""
              )}
            ...
            <EzImage
              ...
              quality={100}
              className={clsx(
                item.stt === 3 ? "pointer-events-none opacity-50" : ""
              )}
              onClick={() => setItems(location[item.stt + 1])}
            />
          </div>
        </div>
        <div className="mx-auto mt-3 w-full max-w-[320px] lg:ml-[14%] lg:mt-10 rounded-[8px] shadow-[8px_15px_15px_0px_rgba(0,_0,_0,_0.10);]">
          <Image
          ...
          <div className="border-t-[6px] border-[#AF0000] bg-white py-3 relative">
            ...
            <div className="px-8 pb-3">
              ...
              <div
                className={clsx(
                  "text-sm text-[#666] mt-2 min-h-[40px] grid gap-1 transition-height duration-300",
                  item?.addres[address]?.content.length > 1 ? "text-xs" : ""
                )}
              >
                {item?.addres[address]?.content &&
                  item?.addres[address]?.content.map(
