...
const FooterItems = () => {
  const b = useTranslation("footerv2").t;
          ...
          <div className="tw-grid tw-col lg:tw-grid-cols-10 lg:tw-col tw-gap-3 tw-mt-3 lg:tw-mt-4">
            <div className="tw-col-span-4">
              <div className="tw-text-[#666] tw-uppercase tw-font-bold tw-text-xs">
                {b("product.items.0.label")}
              </div>
              <div className="tw-grid tw-gap-3 tw-mt-3 lg:tw-mt-4">
                {(
                  b(`product.items.0.itemslv2`, {
                    returnObjects: true,
                  }) as string[]
                ).map((value: any, index: number) => (
                  <Link
            ...
            <div className="tw-col-span-3">
              <div className="tw-text-[#666] tw-uppercase tw-font-bold tw-text-xs">
                {b("product.items.1.label")}
              </div>
              <div className="tw-grid tw-gap-3 tw-mt-3 lg:tw-mt-4">
                {(
                  b(`product.items.1.itemslv2`, {
                    returnObjects: true,
                  }) as string[]
                ).map((value: any, index: number) => (
                  <Link
            ...
            <div className="tw-col-span-3">
              <div className="tw-text-[#666] tw-uppercase tw-font-bold tw-text-xs">
                {b("product.items.2.label")}
              </div>
              <div className="tw-grid tw-gap-3 tw-mt-3 lg:tw-mt-4">
                {(
                  b(`product.items.2.itemslv2`, {
                    returnObjects: true,
                  }) as string[]
                ).map((value: any, index: number) => (
                  <Link
