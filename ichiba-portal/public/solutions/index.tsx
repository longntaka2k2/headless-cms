  ...
  return (
    <div className="h-[126px] flex items-end">
      ...
      >
        ...
        >
          <Image src={xIcon} alt="EFEX" className="w-full h-full" quality={100} />
        </div>
        <div
          className={clsx(
...
const MultiChannel = ({ lang }: { lang: any }) => {
  ...
  return (
    <section className="bg-brand-secondary text-white">
      {/** mobile */}
      <div className="container px-4 pt-8 lg:hidden">
        <div className="w-full flex flex-col items-center text-center">
          <h2 className="text-2xl font-bold">{lang.title}</h2>
          <p className="text-sm text-ic-white-5">{lang.subTitle}</p>
        </div>
        <div className="mt-6">
      ...
      {/** desktop */}
      <div className="container py-20 hidden lg:block">
        <div className="text-center">
          <h2 className="text-4xl leading-[48px] font-bold">{lang.title}</h2>
          <p className="mt-1 text-lg text-ic-white-5">{lang.subTitle}</p>
        </div>
