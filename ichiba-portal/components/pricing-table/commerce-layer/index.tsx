...
const PriceListCommerceLayer = () => {
  const { t: commerce } = useTranslation("commerce-layer");

  return (
    <div className="tw-relative tw-z-[1]">
      <div className="tw-grid tw-grid-cols-10 tw-h-auto tw-items-center tw-sticky tw-bg-white tw-text-base tw-font-bold">
...
export default PriceListCommerceLayer;
