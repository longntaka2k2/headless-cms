...
const serialize = (children: { map: (arg0: (node: any, i: any) => JSX.Element | null) => React.ReactElement<any, string | React.JSXElementConstructor<any>>[] }): React.ReactElement[] =>
  children.map((node: {
    relationTo: string, text: string | null | undefined; bold: any; code: any; italic: any; underline: any; strikethrough: any; type: any; children: any; url: string | null | undefined , value: any 
