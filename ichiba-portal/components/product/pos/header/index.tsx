...
export default function HeaderPOS() {
  const { t: tStore } = useTranslation("pos");
  ...
  const menu = [
    {
      ...
      label: tStore("header.overview"),
    },
    {
      href: "/products/pos/features",
      label: tStore("header.features"),
    },
  ];
        ...
        <div className="container">
          <div className="d-flex justify-content-between tw-gap-2">
            <div className="d-flex tw-justify-between tw-w-full">
              <div className="tw-flex tw-flex-1">
                <div className="tw-flex tw-items-center">
                  <Image
                    src={
                      "https://cms-strapi.ichiba.net/uploads/Logo_84a7806e41.svg"
                    }
                    width={32}
                    height={32}
                    alt="logo"
                ...
                <div className={scrollCount < 99 ? "header-lv2-fixed" : ""}>
                  ...
                  >
                    <div className="tw-p-3 tw-shadow-xl">
                      <div className="tw-hidden max-[473px]:tw-flex tw-gap-3 align-self-center tw-border-b tw-pb-4">
                        <Link
                      ...
                      <div className="tw-flex tw-gap-3">
                        {menu.map((item, index) => (
                          <div
                            key={index}
                            className="tw-mt-0 max-[473px]:tw-mt-2 cursor tw-text-sm tw-relative"
                            onClick={() => router.push(item.href)}
                          >
                            <span
                              className={clsx({
            ...
            <div className="tw-flex tw-gap-2 tw-items-center">
              <div className="max-[473px]:tw-hidden tw-flex align-self-center tw-items-center tw-gap-4 fs-14">
                <Link
                  rel="noreferrer canonical"
                  target="_blank"
                  href="/contact-sales"
