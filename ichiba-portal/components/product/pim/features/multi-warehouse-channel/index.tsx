...
const MultiWarehouseChannel = () => {
  ...
  return (
    <div
      className="tw-bg-bg-light tw-py-5 lg:tw-py-15 tw-scroll-mt-20"
      id="multi-warehouse-multi-channel-inventory"
    >
      <div className="container">
        <div className="tw-flex tw-flex-col lg:tw-flex-row tw-gap-5 lg:tw-gap-[126px] tw-items-center">
          <MixLabel className="tw-flex-1" label={t("multiWarehouseChannel")}>
...
export default MultiWarehouseChannel;
