  ...
  return (
    <div
      ...
      className={clsx(
        ...
        "tw-bg-[linear-gradient(200deg,_rgba(255,_255,_255,_0.70)_22.18%,_#FFF2E0_86.92%)] tw-rounded-lg",
        isVisible ? "tw-animate-showOn" : "tw-opacity-0",
      )}
    >
      <div>
        <h3 className="tw-mb-2 lg:tw-mb-3 tw-text-lg lg:tw-text-2xl tw-font-bold">
          {t("multiCarrier.realTime.title")}
        </h3>
        <div className="tw-flex tw-flex-col tw-gap-4">
          {(
            t(`multiCarrier.realTime.contents`, {
              returnObjects: true,
            }) as string[]
          ).map((content, index) => (
      ...
      <Image
        src="https://cms-strapi.ichiba.net/uploads/high_angle_colleagues_working_together_1_4750a8f605.svg"
        width={522}
        height={312}
