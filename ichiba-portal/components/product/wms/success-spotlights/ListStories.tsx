...
const ListStories = () => {
  ...
  return (
    <div
      className="tw-grid lg:tw-grid-cols-2 tw-items-center tw-gap-6 lg:tw-gap-0 tw-py-5 lg:tw-py-0 lg:tw-px-0 tw-relative tw-overflow-hidden"
      ref={elementRef}
    >
      <div
        className={clsx(
          "lg:tw-px-10 tw-rounded-xl tw-flex tw-flex-col tw-gap-10",
          isVisible
      ...
      >
        ...
        <div>
          ...
          >
            {tWms("successSpotlights.textBtn")}
          </Link>
        </div>
      </div>
      <div
