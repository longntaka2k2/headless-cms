        ...
        <div className="container ">
          <div className="d-flex justify-content-between">
            <div className="d-flex align-items-center">
              ...
              <div className="fw-7 fs-20 ms-2 align-self-center">Cross-Border Forwarding</div>
              <div className="align-self-center ps-lg-3 res-pc fs-14">
                ...
                <Link
                  ...
                  rel="canonical"
                  className={
                    router?.pathname === "/products/cross-border-forwarding/features"
                      ? " color-hl-tab d-inline-block px-3 cursor  text-decoration-none color-black"
                    ...
                    <div className="tw-p-3 tw-shadow-xl">
                      ...
                      <div className="tw-flex tw-gap-3 tw-py-2">
                        ...
                        <div
                          ...
                          onClick={() =>
                            router.push("/products/cross-border-forwarding/features")
                          }
                        >
                          <a
                            className={clsx(
                              router?.pathname ===
                                "/products/cross-border-forwarding/features"
                                ? "text-decoration-none color-hl-tab"
                                : "text-decoration-none tw-text-ic-black-5",
                            )}
                          >
