    ...
    >
      ...
      >
        <div className="tw-flex tw-gap-4 tw-items-center tw-mb-3 lg:tw-mb-6">
          <div className="tw-min-w-[40px] tw-h-10 tw-rounded-lg tw-bg-primary-2 tw-flex tw-items-center tw-justify-center">
            <Image
              src={tCommerce("manageOrders.omnichannel.icon") as string}
              width={24}
              height={24}
              alt={tCommerce("manageOrders.omnichannel.title")}
            />
          </div>
          <h3 className="tw-text-lg lg:tw-text-xl tw-font-bold tw-mb-0">
            {tCommerce("manageOrders.omnichannel.title")}
          </h3>
        </div>
        <div>
          <ul className="tw-list-disc tw-grid tw-gap-4 tw-mb-0">
            {(
              tCommerce(`manageOrders.omnichannel.contents`, {
                returnObjects: true,
              }) as string[]
            ).map((content, index) => (
      ...
      <Image
        src={tCommerce("manageOrders.omnichannel.image") as string}
        width={674}
        height={452}
        alt={tCommerce("manageOrders.omnichannel.title")}
        className={clsx(
