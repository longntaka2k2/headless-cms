        ...
        >
          ...
          >
            <h3 className="tw-text-lg lg:tw-text-xl tw-font-bold tw-mb-7">
              {t("productInformation.manage.title")}
            </h3>
            <div className="tw-bg-[#F2F4F8] tw-rounded-2xl tw-py-5 tw-px-6">
              <Image
                src={t("productInformation.manage.icon") as string}
                width={60}
                height={60}
                alt={t("productInformation.manage.title")}
              />
              <p className="tw-text-sm lg:tw-text-base tw-mt-5 tw-mb-0">
                {t("productInformation.manage.content")}
              </p>
            </div>
          </div>
          <Image
            src={t("productInformation.manage.image") as string}
            width={444}
            height={258}
            alt={t("productInformation.manage.title")}
            className={clsx(
