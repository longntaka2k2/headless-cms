        ...
        >
          ...
          >
            <h3 className="tw-text-lg lg:tw-text-xl tw-font-bold tw-mb-7">
              {t("productInformation.advanced.title")}
            </h3>
            <div className="tw-bg-[#F2F4F8] tw-rounded-2xl tw-py-5 tw-px-6">
              <Image
                src={t("productInformation.advanced.icon") as string}
                width={60}
                height={60}
                alt={t("productInformation.advanced.title")}
              />
              <p className="tw-text-sm lg:tw-text-base tw-mt-5 tw-mb-0">
                {t("productInformation.advanced.content")}
              </p>
            </div>
          </div>
          <Image
            src={t("productInformation.advanced.image") as string}
            width={444}
            height={258}
            alt={t("productInformation.advanced.title")}
            className={clsx(
