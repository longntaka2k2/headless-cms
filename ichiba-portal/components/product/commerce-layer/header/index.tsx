...
import logo from "@/public/icons/products/commerce-layer.svg";
  ...
  const menu = [
    {
      ...
      label: tCommerce("menu.overview"),
    },
    {
      href: "/products/commerce-layer/features",
      label: tCommerce("menu.features"),
    },
    {
      href: "/products/commerce-layer/pos",
      label: tCommerce("menu.pos"),
    },
    {
      href: "/products/commerce-layer/overview/#",
      label: tCommerce("menu.automationEngagement"),
    }
  ];
