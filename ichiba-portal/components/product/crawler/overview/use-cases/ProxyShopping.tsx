...
const ProxyShopping = () => {
  ...
  return (
    <div
      ref={elementRef}
      className="tw-bg-white tw-flex tw-flex-col lg:tw-flex-row tw-rounded-2xl tw-gap-6 lg:tw-gap-5 tw-items-center tw-overflow-hidden tw-shadow-[0px_8px_16px_0px_rgba(0,_0,_0,_0.05)]"
    >
      <div
        className={clsx(
          "tw-pt-5 tw-px-5 lg:tw-pl-10 lg:tw-pr-0",
          isVisible
      ...
      >
        <h3 className="tw-text-lg lg:tw-text-2xl tw-font-bold tw-mb-2">
          {crawler("useCases.contents.0.title")}
        </h3>
        <p className="tw-text-sm lg:tw-text-base tw-mb-2">
          {crawler("useCases.contents.0.des")}
        </p>
        <Link
          href={"/solutions/proxy-shopping"}
          target="_blank"
      ...
      <Image
        src="https://cms-strapi.ichiba.net/uploads/image_849_41f5dceff2.svg"
        width={657}
        height={444}
        alt="#"
        className={clsx(
