...
const Contact = () => {
  ...
  return (
    <div className="tw-py-10 lg:tw-py-15 tw-px-4" ref={elementRef}>
      <div
        className={clsx(
          "lg:tw-container tw-relative tw-rounded-2xl tw-bg-[url(https://cms-strapi.ichiba.net/uploads/Frame_1171275830_27517ec19b.svg)] tw-bg-cover",
          "tw-mx-4 tw-py-6 tw-px-4 lg:tw-py-10 lg:tw-px-20",
          isVisible ? "tw-animate-showOn" : "tw-opacity-0",
        )}
      >
        <p className="tw-text-sm lg:tw-text-lg tw-font-medium tw-text-white tw-mb-2">
          {crawler("contact.label")}
        </p>
        <h2 className="tw-text-2xl lg:tw-text-3xl tw-font-bold tw-text-white tw-mb-8 lg:tw-w-[95%]">
          {crawler("contact.heading")}
        </h2>
