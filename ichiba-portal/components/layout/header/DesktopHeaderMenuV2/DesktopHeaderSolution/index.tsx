...
const DesktopHeaderSolution = ({
  ...
  const renderItems = (value: any, index: number) => {
    return (
      <div
        className="tw-col-span-6 tw-grid-2"
        key={`${value.title}_${idx}_${index}`}
      >
        {value.title && (
          <div className="fw-5  tw-text-[#666] tw-border-[#ddd] tw-border-b tw-w-[90%] tw-pb-1">
            {value.title}
          </div>
        )}
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div className={clsx("")}>
              <div className="tw-grid tw-grid-cols-12 tw-py-4 tw-px-5 tw-gap-2">
...
export default DesktopHeaderSolution;
