  ...
  return (
    ...
    >
      <div className="lg:tw-container tw-px-4">
        <h2 className="tw-text-2xl tw-font-bold lg:tw-text-4xl tw-mb-6 lg:tw-mb-15">
          {t("discoverProducts.heading")}
        </h2>
