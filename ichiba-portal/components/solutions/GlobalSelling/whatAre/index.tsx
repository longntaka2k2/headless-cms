      ...
      <div className="lg:tw-container">
        ...
        <div className="tw-mt-5 tw-flex tw-overflow-x-scroll lg:tw-overflow-x-auto tw-gap-4 tw-scroll-px-2 tw-scroll-mx-48 lg:tw-relative lg:tw-pb-5 lg:tw-mt-[50px]">
          {(
            ...
            <div
              key={index}
              className="tw-min-w-[237px] tw-h-[280px] lg:tw-h-full lg:tw-min-h-[332px] lg:tw-min-w-[342px] tw-rounded-lg tw-border tw-border-[#ddd] tw-p-4 lg:tw-p-6 tw-grid tw-content-between tw-bg-white "
            >
              <div>
                <Image
                  src={value.icons}
              ...
              <Link
                href={value.link}
                className="tw-block tw-no-underline tw-text-sm tw-font-medium tw-text-[#F57C00] lg:tw-text-base"
              >
                {g("whatAre.viewMore")}{" "}
