...
const Custommized = () => {
  ...
  return (
    <div className="tw-px-4 lg:tw-px-0 tw-py-10 tw-container lg:tw-grid-cols-2 tw-grid tw-grid-cols-1 lg:tw-gap-10 tw-gap-6 tw-items-center">
      <Image
        src={
          "https://cms-strapi.ichiba.net/uploads/Group_19807_06ca783234.svg"
        }
        alt="https://cms-strapi.ichiba.net/uploads/Group_19807_06ca783234.svg"
        width={674}
        height={717}
        quality={100}
      ...
      <div>
        <div className="tw-text-xl tw-font-bold lg:tw-text-3xl">
          {t("globalBrand.customized.title")}
        </div>
        <div className="tw-grid tw-gap-4 tw-mt-6">
          ...
          >
            ...
            <div className=" tw-px-6 tw-py-4 tw-bg-white tw-rounded-xl">
              {t("globalBrand.customized.content.custom")}
            </div>
          </div>
          <div
            className={clsx(
          ...
          >
            ...
            <div className=" tw-px-6 tw-py-4 tw-bg-white tw-rounded-xl">
              {t("globalBrand.customized.content.gather")}
            </div>
          </div>
        </div>
      </div>
