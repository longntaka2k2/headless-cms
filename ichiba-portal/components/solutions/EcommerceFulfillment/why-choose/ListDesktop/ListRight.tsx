...
const ListRight = () => {
  ...
  const icons = [
    "box-delivery-rotate",
    "fast-delivery",
    "24-support-circle-checkmark",
    "document-checkmark",
  ];

  return (
    <div className="tw-relative">
      <div className="tw-max-w-[1444px] tw-ml-auto">
        <AspectRatio x={1444} y={760}>
          <div className="tw-relative tw-w-full tw-h-full lg:tw-bg-[url('/icons/ecommerce-fulfillment/why-choose-bg-right.png')] tw-bg-no-repeat tw-bg-cover"></div>
        </AspectRatio>
      </div>
                ...
                <button
                  ...
                  className={clsx(
                    "tw-w-[260px] lg:tw-min-h-[104px] xl:tw-min-h-[120px] tw-rounded-[100px] tw-flex tw-items-center tw-justify-center tw-gap-4 tw-bg-white tw-p-4 xl:tw-p-6",
                    {
                      ...
                      "2xl:tw-translate-x-0 tw-translate-x-12": [0, 3].includes(
                        index,
                      ),
                      "tw-text-white": index === activeIndex,
                    },
                    index === activeIndex
