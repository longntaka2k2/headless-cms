    ...
    >
      <div className="lg:tw-container">
        ...
        <div className="tw-mt-5 tw-flex tw-overflow-x-scroll lg:tw-overflow-x-auto tw-gap-4 tw-scroll-px-2 tw-scroll-mx-48 lg:tw-relative lg:tw-pb-5 lg:tw-mt-[50px]">
          {(
            p("whatAreTheRight.items", {
              returnObjects: true,
            }) as string[]
          ).map((value: any, index: number) => (
            <div
              key={index}
              className="tw-min-w-[237px] tw-h-[280px] lg:tw-min-h-[342px] lg:tw-min-w-[332px] tw-rounded-lg tw-border tw-border-[#ddd] tw-p-4 lg:tw-p-6 tw-grid tw-content-between tw-bg-white "
            >
              <div>
                <Image
                  src={value.icon}
...
export default WhatAreTheRight;
