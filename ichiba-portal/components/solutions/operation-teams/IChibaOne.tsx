...
const IChibaOne = () => {
  const b = useTranslation("operation-teams").t;

  return (
    <div className="tw-py-6 tw-px-4 lg:tw-container lg:tw-flex tw-gap-[126px] lg:tw-pt-20 lg:tw-pb-15">
      <h4 className="tw-text-2xl tw-font-bold lg:tw-text-4xl lg:tw-max-w-[384px]">
        {b("iChiba.title")}
      </h4>
      <div className="tw-grid tw-gap-3 lg:tw-gap-6 tw-mt-4 lg:tw-flex-1">
        ...
        >
          <div className="tw-text-lg tw-font-bold lg:tw-text-2xl">
            {b("iChiba.items.1.title")}
          </div>
          <div className="tw-text-sm tw-mt-2 lg:tw-text-base">
            {b("iChiba.items.1.content")}
          </div>
        </div>
        <div
          className={clsx(
        ...
        >
          <div className="tw-text-lg tw-font-bold lg:tw-text-2xl">
            {b("iChiba.items.2.title")}
          </div>
          <div className="tw-text-sm tw-mt-2 lg:tw-text-base">
            {b("iChiba.items.2.content")}
          </div>
        </div>
      </div>
    </div>
