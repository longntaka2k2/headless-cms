import LogisticsCompanyCPN from "@/components/solutions/LogisticsCompany";
...
export default function LogisticsCompany() {
  ...
  const link =
    router.locale === "en"
      ? "https://ichiba.vn/en/solutions/logistics-company"
      : "https://ichiba.vn/solutions/logistics-company";
