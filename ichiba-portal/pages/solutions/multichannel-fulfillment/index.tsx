...
import MultichannelFulfillmentCpn from "@/components/solutions/MultichannelFulfillment";
import Head from "next/head";
import { useRouter } from "next/router";
import { useEffect, useState } from "react";
import { GetMeta } from "@/services/strapi";

export default function MultichannelFulfillment() {
  const { t } = useTranslation("common");
  const router = useRouter();
  const [meta, setMeta] = useState([] as any);
  const link =
    router.locale === "en"
      ? "https://ichiba.vn/en/solutions/multichannel-fulfillment"
      : "https://ichiba.vn/solutions/multichannel-fulfillment";
