...
import OperationTeamsCPN from "@/components/solutions/operation-teams";
import { useRouter } from "next/router";
import { useEffect, useState } from "react";
import { GetMeta } from "@/services/strapi";

export default function OperationTeam() {
  const { t } = useTranslation("common");
  const router = useRouter();
  const [meta, setMeta] = useState([] as any);
  const link =
    router.locale === "en"
      ? "https://ichiba.vn/en/solutions/operation-teams"
      : "https://ichiba.vn/solutions/operation-teams";
