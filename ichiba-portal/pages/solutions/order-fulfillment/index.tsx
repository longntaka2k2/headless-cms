...
// import OrderFulfillmentView from "@/components/solutions/OrderFulfillment";
import { LocaleNamespace } from "@/const/locale";
import OrderFulfillmentViewV2 from "@/components/solutions/OrderFulfillmentV2";
import { useRouter } from "next/router";
import { useEffect, useState } from "react";
import { GetMeta } from "@/services/strapi";

export default function OrderFullfilment() {
  ...
  const link =
    router.locale === "en"
      ? "https://ichiba.vn/en/solutions/order-fulfillment"
      : "https://ichiba.vn/solutions/order-fulfillment";
