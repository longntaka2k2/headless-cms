...
import OmnichannelSellingCpn from "@/components/solutions/OmnichannelSelling";
import Head from "next/head";
import { useRouter } from "next/router";
import { useEffect, useState } from "react";
import { GetMeta } from "@/services/strapi";

export default function OmnichannelSelling() {
  const { t } = useTranslation("common");
  const router = useRouter();
  const [meta, setMeta] = useState([] as any);
  const link =
    router.locale === "en"
      ? "https://ichiba.vn/en/solutions/omnichannel-selling"
      : "https://ichiba.vn/solutions/omnichannel-selling";
