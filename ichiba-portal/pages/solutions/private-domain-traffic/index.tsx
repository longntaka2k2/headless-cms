import PrivateDomainTrafficCPN from "@/components/solutions/private-domain-traffic";
...
export default function PrivateDomainTraffic() {
  const { t } = useTranslation("common");
  const router = useRouter();
  const [meta, setMeta] = useState([] as any);
  const link =
    router.locale === "en"
      ? "https://ichiba.vn/en/solutions/mother-baby"
      : "https://ichiba.vn/solutions/mother-baby";
