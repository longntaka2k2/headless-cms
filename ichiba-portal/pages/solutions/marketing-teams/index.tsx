import MarketingTeamsCPN from "@/components/solutions/MarketingTeams";
...
export default function MarketingTeams() {
  ...
  const link =
    router.locale === "en"
      ? "https://ichiba.vn/en/solutions/marketing-teams"
      : "https://ichiba.vn/solutions/marketing-teams";
