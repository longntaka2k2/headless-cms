...
import TechnicalTeamsCPN from "@/components/solutions/technical-teams";
...
export default function TechnicalTeams() {
  ...
  const link =
    router.locale === "en"
      ? "https://ichiba.vn/en/solutions/technical-teams"
      : "https://ichiba.vn/solutions/technical-teams";
