...
import DigitalOverview from "@/components/product/digital-commerce/overview";
import StoreFrontOverview from "@/components/product/storeFront/Overiew";
...
export default function OverView() {
  ...
  const link =
    router.locale === "en"
      ? "https://ichiba.vn/en/products/storefront-layer/overview"
      : "https://ichiba.vn/products/storefront-layer/overview";
