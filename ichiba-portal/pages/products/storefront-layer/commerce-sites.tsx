import CommerceSites from "@/components/product/storeFront/Commerce";
...
export default function CommercesitePage() {
  ...
  const link =
    router.locale === "en"
      ? "https://ichiba.vn/en/products/storefront-layer/commerce-sites"
      : "https://ichiba.vn/products/storefront-layer/commerce-sites";
